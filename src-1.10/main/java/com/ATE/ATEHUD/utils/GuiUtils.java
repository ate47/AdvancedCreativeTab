...
public class GuiUtils {
    ...
    public static void drawCenterString(FontRenderer fontRendererObj,String text,int x,int y,int HEIGHT,int color) {
    	fontRendererObj.drawString(text, x-fontRendererObj.getStringWidth(text)/2, y+HEIGHT/2-fontRendererObj.FONT_HEIGHT/2,color);
    }
    public static void drawRightString(FontRenderer fontRendererObj,String text,int x,int y,int HEIGHT,int color) {
    	fontRendererObj.drawString(text, x-fontRendererObj.getStringWidth(text), y+HEIGHT/2-fontRendererObj.FONT_HEIGHT/2,color);
    }
	public static void drawTextBox(GuiScreen guiScreen,Minecraft mc,FontRenderer fontRendererObj, String[] text,int X,int Y,int TextColor){
        ...
        for (int i = 0; i < text.length; i++) {
			if(fontRendererObj.getStringWidth(text[i])>maxSize)maxSize=fontRendererObj.getStringWidth(text[i]);
		}
	...
	public static void buttonHoverMessage(GuiScreen guiScreen,Minecraft mc,GuiButton button,int mouseX,int mouseY,FontRenderer fontRendererObj,String[] text,int color){
