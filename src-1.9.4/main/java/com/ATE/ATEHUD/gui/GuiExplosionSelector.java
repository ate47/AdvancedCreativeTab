...
public class GuiExplosionSelector extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		fontRendererObj.drawString(I18n.format("gui.act.type"),
				width/2-200+100-fontRendererObj.getStringWidth(I18n.format("gui.act.type"))/2,
		...
		nbFadeColor=b;
		String s=I18n.format("gui.act.explosion")+(Integer)(ExpIndex+1);
