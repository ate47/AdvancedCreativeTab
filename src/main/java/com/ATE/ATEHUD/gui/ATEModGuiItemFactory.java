...
public class ATEModGuiItemFactory extends GuiScreen{
	...
	public ATEModGuiItemFactory(){}
	public ATEModGuiItemFactory(GuiScreen last){
		Last=last;
	}
	...
	public String getNbt(){
		...
		String unb="";
		if(unbreak.packedFGColour==ATEModGuiAttributeSelector.buttonYESColor)unb="Unbreakable:1,";
		return "{"+unb+"display:{Name:\""+name.getText()+"\",Lore:"+getLoreNbt()+"},AttributeModifiers:"+getAttributeNbt()+
				",ench:"+getEnchNbt()+"}";
	}
	...
	public void initGui() {
		...
		unbreak.packedFGColour=ATEModGuiAttributeSelector.buttonNOColor;
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 1://Give
			try {
				is=FakeItems3.getGive(item.getText()+" 1 "+meta.getText()+" "+getNbt());
				GiveItem.give(mc, is);
		...
		case 3://Enchants
			Minecraft.getMinecraft().displayGuiScreen(new ATEModGuiEnchantSelector(this));break;
		case 4://Attribute
			Minecraft.getMinecraft().displayGuiScreen(new ATEModGuiAttributeSelector(this));break;
		case 5://Lore
			Minecraft.getMinecraft().displayGuiScreen(new ATEModGuiLoreSelector(this));break;
		case 6:
			if(unbreak.packedFGColour==ATEModGuiAttributeSelector.buttonNOColor){
				unbreak.packedFGColour=ATEModGuiAttributeSelector.buttonYESColor;
			}else{
				unbreak.packedFGColour=ATEModGuiAttributeSelector.buttonNOColor;
			}
			break;
