...
public class ChatUtils {
	...
	public static ITextComponent getErrorPrefix() {
		return getPrefix(new TextComponentString(I18n.format("gui.act.error"))
				.setChatStyle(new Style().setColor(TextFormatting.RED)), TextFormatting.WHITE);
	}
	...
	private static ITextComponent getPrefix(ITextComponent notif, TextFormatting endColor) {
		ITextComponent p = new TextComponentString("")
				.setChatStyle(new Style().setColor(endColor != null ? endColor : TextFormatting.WHITE))
				.appendSibling(new TextComponentString("[").setChatStyle(new Style().setColor(TextFormatting.RED))
						.appendSibling(new TextComponentString(ACTMod.MOD_LITTLE_NAME)
								.setChatStyle(new Style().setColor(TextFormatting.GOLD))));
		if (notif != null)
			p.appendSibling(new TextComponentString("/").setChatStyle(new Style().setColor(TextFormatting.WHITE)))
					.appendSibling(notif);
		return p.appendSibling(new TextComponentString("]").setChatStyle(new Style().setColor(TextFormatting.RED)))
