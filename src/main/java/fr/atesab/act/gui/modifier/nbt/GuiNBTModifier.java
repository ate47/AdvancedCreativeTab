...
public class GuiNBTModifier extends GuiListModifier<CompoundTag> {
	...
	public static final BiConsumer<Integer, GuiListModifier<?>> ADD_ELEMENT = (i, lm) -> {
		final GuiStringModifier modifier = new GuiStringModifier(lm, new TranslatableComponent("gui.act.modifier.name"),
				"", null);
	...
	public static GuiButtonListSelector<Tag> addElement(int i, GuiListModifier<?> lm, String key) {
		return new GuiButtonListSelector<>(lm, new TranslatableComponent("gui.act.modifier.tag.editor"), Arrays.asList(
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.tag"), new CompoundTag()),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.string"), StringTag.valueOf("")),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.int"), IntTag.valueOf(0)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.long"), LongTag.valueOf(0L)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.float"), FloatTag.valueOf(0F)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.double"), DoubleTag.valueOf(0D)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.short"), ShortTag.valueOf((short) 0)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.intArray"), new IntArrayTag(new int[0])),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.longArray"),
						new LongArrayTag(new long[0])),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.byte"), ByteTag.valueOf((byte) 0)),
				new Tuple<String, Tag>(I18n.get("gui.act.modifier.tag.editor.list"), new ListTag())), base -> {
	...
	public GuiNBTModifier(Screen parent, Consumer<CompoundTag> setter, CompoundTag tag) {
		this(new TextComponent("/"), parent, setter, tag);
	}
	...
	public GuiNBTModifier(Component title, Screen parent, Consumer<CompoundTag> setter, CompoundTag tag) {
		...
		addListElement(new ButtonElementList(200, 21, 200, 20, new TextComponent("+").withStyle(ChatFormatting.GREEN),
